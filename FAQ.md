...
This error will appear if an the Microsoft Admin did not consent to the permissions in Microsoft 365 Admin Center.  Since this addin makes API calls to Microsoft Graph API, an admin is required to consent to the permissions before end users can use the addin.
